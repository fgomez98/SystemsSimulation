...
#         subprocess.call(['java', '-jar', 'CellularAutomata-jar-with-dependencies.jar', '-Dl=' + str(L[i]), '-Dn=' + str(N[i]), '-Dr=' + str(n[j]), '-Dt=3000'])
...
# Y40 = np.array([[1, 0.937, 0.745, 0.53, 0.256, 0.193], [1, 0.935, 0.753, 0.51, 0.251, 0.21], [0.999, 0.932, 0.753, 0.532, 0.258, 0.193]])
...
# Y100 = np.array([[1, 0.934, 0.728, 0.472, 0.179, 0.12], [0.999, 0.934, 0.736, 0.485, 0.17, 0.134], [1, 0.93, 0.725, 0.442, 0.16, 0.12]])
...
# Y400 = np.array([[1, 0.92, 0.68, 0.365, 0.078, 0.059], [0.999, 0.93, 0.67, 0.316, 0.078, 0.063], [1, 0.925, 0.675, 0.34, 0.079, 0.056]])
...
# Y4000 = np.array([[1, 0.87, 0.52, 0.19, 0.024, 0.017], [0.99, 0.9, 0.585, 0.11, 0.024, 0.018], [0.99, 0.89, 0.57, 0.13, 0.022, 0.196]])
...
# Y = np.array([[0.184, 0.28, 0.38, 0.701, 0.78, 0.81], [0.199, 0.26, 0.379, 0.63, 0.783, 0.82], [0.165, 0.2, 0.33, 0.688, 0.8, 0.81]])
